    ...
    $.fn.uploadFile = function (options) {
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '1px dotted #AAA');
            });
        ...
        function createProgressDiv(obj, s) {
            ...
            /*
            this.statusbar = $("<div class='panel-body'></div>").appendTo($("<div class='panel panel-default'></div>"));
            this.filename = $("<h5 class='ajax-file-upload-filename'></h5>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='progress-bar " + obj.formGroup + "'></div>").appendTo(this.progressDiv);
            
            this.abort = $("<div class='" + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = $("<button class='btn btn-danger'>" + s.cancelStr + "</button>").appendTo(this.statusbar).hide();
            this.done = $("<button class='btn btn-success'>" + s.doneStr + "</button>").appendTo(this.statusbar).hide();
            this.del = $("<button class='btn btn-danger'>" + s.deletelStr + "</button>").appendTo(this.statusbar).hide();
            */
